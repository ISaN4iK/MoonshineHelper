...
namespace RGRv2
{
    public partial class AddFlaver : Form
    {
        ...
        {
            database.Open();
            MySqlCommand cmd = new MySqlCommand("INSERT INTO Flavors (Flavor_name) VALUES ('"
        ...
        {
            database.Open();
            MySqlCommand cmd = new MySqlCommand("SELECT count(*) FROM Flavors "
                                    + " WHERE Flavor_name = '"
